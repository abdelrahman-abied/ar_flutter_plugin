...
class ARPlaneAnchor extends ARAnchor {
  ARPlaneAnchor({
    ...
    int? ttl,
        ...
        ttl = ttl ?? 1,
        super(type: AnchorType.plane, transformation: transformation, name: name);
...
ARPlaneAnchor aRPlaneAnchorFromJson(Map<String, dynamic> json) {
  return ARPlaneAnchor(
    ...
    childNodes: json['childNodes']?.map((child) => child.toString())?.toList()?.cast<String>(),
...
class ARUnkownAnchor extends ARAnchor {
  ...
  static ARUnkownAnchor fromJson(Map<String, dynamic> json) => aRUnkownAnchorFromJson(json);
